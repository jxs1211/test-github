...
public class SlideMenuPopWindow extends PopupWindow
    ...
    public SlideMenuPopWindow(Context context, List<?> paramList)
        ...
        this.mConvertView = LayoutInflater.from(context).inflate(myapplication.R.layout.slide_menu_popup_window_main, null);
...
//    context = getDisplayMetrics(context);
    ...
    private void initDatas()
        {
        this.mAdapter = new PopupWindowListViewAdapter(this.mContext, this.mDatas, myapplication.R.layout.slide_menu_item);
    ...
    private void initViews()
        {
        this.mRecyclerView = ((RecyclerView) this.mConvertView.findViewById(myapplication.R.id.rv_slide_menu));
        }
